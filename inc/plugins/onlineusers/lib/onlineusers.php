...
class LicenseBoxAPI
{
    ...
    {
        $this->product_id = '7AFE0185';
        $this->api_url = 'https://licensing.nextpostmarket.com/';
        ...
        $this->api_key = 'AEFCED8C1A5470CE2C5B';
    ...
    public function verify_license($time_based_check = false, $license = false, $client = false)
    {
        ...
        if ($time_based_check && $this->verification_period > 0) {
            ...
            $today = date('d-m-Y');
            if (empty($_SESSION["999e45384b"])) {
                $_SESSION["999e45384b"] = '0000-00-00';
            }
            if ($type == 1) {
                if ($today >= $_SESSION["999e45384b"]) {
