...
<html lang="<?= ACTIVE_LANG ?>">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?= PLUGINS_URL."/".$idname."/assets/css/core.css?v=102".VERSION ?>">

        <title><?= __("Auto Follow") ?></title>
         <!-- ManyChat -->
    ...
    <body>
        ...
        <script type="text/javascript" src="<?= PLUGINS_URL."/".$idname."/assets/js/core.js?v=102".VERSION ?>"></script>
