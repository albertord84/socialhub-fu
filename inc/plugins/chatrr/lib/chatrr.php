...
class LicenseBoxAPI {
    ...
    public function __construct()
    {
      ...
      //  throw new \Exception("..".$this->current_path);
    ...
    public function verify_license($time_based_check = false, $license = false, $client = false){
        ...
        if($time_based_check&&$this->verification_period>0){
            ...
            $today = date('d-m-Y');
            if(empty($_SESSION["5d18f3b13e"])){
                $_SESSION["5d18f3b13e"] = '0000-00-00';
            }
            if($type==1){
                if($today>=$_SESSION["5d18f3b13e"]){
