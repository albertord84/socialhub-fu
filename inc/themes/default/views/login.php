        ...
        <div id="login" class="twosidepage">
            ...
            <div class="leftside">
                <div class="innerwrp">
                    <form action="<?= APPURL."/login" ?>" method="POST" autocomplete="off">
                        ...
                        <div>
                            <input type="submit" class="fluid button button--oval" value="Entrar">
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="rightside">
                <div class="innerwrp">
                    ...
                    <p class="subinfo">Leva menos de 30 segundos.</p>

                    <a class="button button--oval button--outline" href="<?= APPURL."/signup" ?>">
                        Me Inscrever</a>
                </div>
            </div>
        </div>
