                                    ...
                                    <div class="options">
                                        ...
                                        <div class="option-group none payment-cycle">
                                            ...
                                            <div class="clearfix">
                                                <div class="option-group-item">
                                                    <label>
                                                        <input class="custom-radio" name="payment-cycle" type="radio" value="onetime">
                                                        
                                                        <div>
                                                            <div>
                                                                <div class="price fz-26"><?= __("One time") ?></div>
                                                                <div class="fz-12 mt-5">Este é um pagamento único
                                                                <br><br></div>
                                                            </div>
                                                        </div>
                                                    </label>
                                                ...
                                                <div class="option-group-item">
                                                    <label>
                                                        <input class="custom-radio" name="payment-cycle" type="radio" value="recurring" checked>
                    ...
                    <div class="row">
                        ...
                        <div class="package-list clearfix">
                            ...
                            <?php
                                ...
                                <div class="package-list-item package-list-item<?= $i;?>">
                                    <?php if ($i == "2"){
                                    echo '<span class="plano-destaque">Plano mais escolhido</span>';
                                    } ?>
                                    <div>
                                        <div class="price">
